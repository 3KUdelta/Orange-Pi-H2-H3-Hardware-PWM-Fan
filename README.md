...
How to control a PWM fan depending on CPU temperature on a OrangePi Zero (H2+ / H3) directly from the harware pwm pin (without a transistor, diode and resistor)? The current settings keeps the temperature below 50 degrees Celcius.
